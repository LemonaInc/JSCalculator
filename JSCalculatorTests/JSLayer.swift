...
class JSLayer {
    ...
    // MARK - Animation
    func animateScaleForCircleLayer(fromScale: Float, toScale: Float, timingFunction: JSTimingFunction, duration: CFTimeInterval) {
    ...
    func animateAlphaForBackgroundLayer(timingFunction: JSTimingFunction, duration: CFTimeInterval) {
    ...
    func animateSuperLayerShadow(fromRadius: CGFloat, toRadius: CGFloat, fromOpacity: Float, toOpacity: Float, timingFunction: JSTimingFunction, duration: CFTimeInterval) {
    ...
    private func animateShadowForLayer(layer: CALayer, fromRadius: CGFloat, toRadius: CGFloat, fromOpacity: Float, toOpacity: Float, timingFunction: JSTimingFunction, duration: CFTimeInterval) {
